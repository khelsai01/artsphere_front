...
const Navbar = () => {
  ...
  const handleSearch = () => {
    ...
    axios
      .get(`https://gifted-kit-cow.cyclic.app/admin/search?title=${search}`)
      .then((res) => {
  ...
  return (
    <Box
      w={"100%"}
      bgColor={theme === "dark" ? "#15191E" : "#edf2f7"}
    ...
    >
      ...
      >
        <Image
          src="https://firebasestorage.googleapis.com/v0/b/festive-crayon.appspot.com/o/Posts%2FCraft_Ideas1-removebg.png029b92d9-75e9-48d1-b100-5b790f007a6c?alt=media&token=b496407b-289a-45d6-952d-9bb82d176b81"
          alt="logo"
          objectFit={"cover"}
          w={"10%"}
        ...
        >
          <Icon
            as={theme === "dark" ? BsSun : BsMoonStars}
            fontSize={"xl"}
            ...
            <HStack spacing="1rem">
              ...
              {subscription === "basic" ? (
                <Button
                  bgColor="#FF7F50"
                  color={"white"}
                  _hover={{ backgroundColor: "#91D9A8", color: "coral" }}
                  onClick={() => {
                    navigate("/plans");
                  }}
                >
