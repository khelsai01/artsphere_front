...
const AddPost = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(
        "https://artsphere.onrender.com/arts/add",
        {
          image,
          title,
          tags,
        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <Select
                onChange={(e) => {
                  dispatch({ type: "CATAGORY", payload: e.target.value });
                }}
                bgColor={theme === "dark" ? "#15191E" : "#edf2f7"}
                color={theme === "dark" ? "white" : "black"}
              ...
              <InputGroup size="md">
                ...
                <InputRightElement w="4.5rem">
                  <Button size="md" onClick={tagHandler}>
                    Add Tag
                  </Button>
                </InputRightElement>
              </InputGroup>
              ...
              <RadioGroup
                onChange={(e) => {
                  dispatch({ type: "VERSION", payload: e });
                }}
              >
                <Stack direction="row">
