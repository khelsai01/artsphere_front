    ...
    >
      {!comments ? (
        <Flex height="80vh" align="center" justify="center">
          <Image
            src="https://i.ibb.co/68zbKqX/output-onlinegiftools.gif"
            w={"10%"}
            h={"10%"}
          />
        </Flex>
              ...
              >
                <Box display={"flex"} m={"auto"} w={"50%"} gap={"0.5rem"}>
                  ...
                  <Stack gap={"auto"} direction={"column"} columnGap={"0px"}>
                    <Text mt={"auto"} fontSize={"20px"} fontWeight={500}>
                      {data.title}
                    </Text>
                ...
                {comments?.length == 0 && (
                  ...
                  >
                    <Text textAlign={"center"} fontSize={"xl"} fontWeight={500}>
                      No comments are present, be first to comment on this post.
                    </Text>
                  </Box>
                )}
                {comments.length > 0 &&
