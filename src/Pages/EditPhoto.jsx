...
const EditPhoto = () => {
  ...
  return (
    <div
      style={{
        padding: "40px",
        backgroundColor: `${theme}` === "dark" ? "#15191E" : "#edf2f7",
        ...
        <div>
          ...
          <IMGDIV>
            <IMG
              ...
              grayscale={grayscale}
              id="preview-img"
              src="https://i.pinimg.com/564x/ce/22/32/ce22327fa176a92798cdbd1589391cc2.jpg"
              alt=""
            />
